...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_create_trade1(self):
        ...
        # Третий торг(размещен повторно, аукцион, Без указания НМЦ, не аккредитованный,загружено несколько спецификаций через шаблон(не сделано), со ставкой, будет отменен)
        _buttons.re_create(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade3_link(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade4_link(self, driver)
        ...
        _buttons.publish(self, driver)
        _trade_constructor.trade5_link(self, driver)

        # Шестой торг(размещен повторно, аукцион, со снижением НМЦ, не аккредитованный,прикреплены документы при создании в : Требования к предмету закупки и Форма коммерческого предложения(не сделано), закрытая переторжка)
        _buttons.re_create(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade6_link(self, driver)
        ...
        _trade_constructor.shtuka_spec(self, driver)
        _buttons.publish(self, driver)
        _links.trade7_link(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade8_link(self, driver)

        # Девятый торг(размещен повторно, закрытый, Без указания НМЦ, не аккредитованный,загружено несколько спецификаций через шаблон(не сделано), со ставкой, будет отменен)
        _buttons.re_create(self, driver)
        _trade_constructor.bez_ukazania_nmc(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade9_link(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade10_link(self, driver)
        ...
        _trade_constructor.Third_spec(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade11_link(self, driver)

        # Двенадцатый торг(размещен повторно, закрытый, со снижением НМЦ, не аккредитованный,прикреплены документы при создании в : Требования к предмету закупки и Форма коммерческого предложения(не сделано), закрытая переторжка)
        _buttons.re_create(self, driver)
        ...
        _trade_constructor.date_end(self, driver)
        _buttons.publish(self, driver)
        _trade_constructor.trade12_link(self, driver)
